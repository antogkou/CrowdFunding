...
namespace CrowdFundingMVC.Migrations
{
    ...
    [Migration("20200521081423_searchproject")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CrowdFundingMVC.Areas.Identity.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("CrowdFundingMVC.Models.Multimedia", b =>
                {
            ...
            modelBuilder.Entity("CrowdFundingMVC.Models.Project", b =>
                {
                    b.Property<int>("ProjectId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CrowdFundingMVC.Models.Multimedia", b =>
                {
                    b.HasOne("CrowdFundingMVC.Models.Project", "Project")
                        .WithMany()
            ...
            modelBuilder.Entity("CrowdFundingMVC.Models.Project", b =>
                {
                    b.HasOne("CrowdFundingMVC.Areas.Identity.Data.ApplicationUser", null)
                        .WithMany("Projects")
            ...
            modelBuilder.Entity("CrowdFundingMVC.Models.BackedProjects", b =>
                {
                    b.HasOne("CrowdFundingMVC.Areas.Identity.Data.ApplicationUser", "ApplicationUser")
                        .WithMany()
                        .HasForeignKey("ApplicationUserId");
